...
ENV PYTHONDONTWRITEBYTECODE=1 PYTHONUNBUFFERED=1 MPLBACKEND=Agg \
    ...
    XDG_CACHE_HOME=/opt/sked-cache MPLCONFIGDIR=/opt/sked-cache/matplotlib \
...
RUN python -c "from matplotlib import font_manager; print('Matplotlib font cache ready')"
EXPOSE 8000
